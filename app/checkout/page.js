...
export default function CheckoutPage() {
  ...
  const calculateTotal = () => {
    ...
    const deliveryFee = total >= 100 && formData.deliveryOption === 'standard' ? 0 : selectedDelivery?.price || 0
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <motion.div variants={itemVariants} className="space-y-6">
            ...
            {/* Delivery Options */}
            <div className="bg-white rounded-2xl shadow-md p-6">
              <h2 className="text-2xl font-bold text-black mb-6">Delivery Options</h2>
              <RadioGroup
                ...
                {deliveryOptions.map((option) => (
                  <div key={option.id} className="flex items-center space-x-2 p-3 border rounded-lg">
                    ...
                    <span className="font-semibold">
                      {total >= 100 && option.id === 'standard' ? 'Free' : `$${option.price}`}
                    </span>
                  </div>
                ))}
              </RadioGroup>
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold">
                    {total >= 100 && formData.deliveryOption === 'standard' 
                      ? 'Free' 
                      : `$${deliveryOptions.find(o => o.id === formData.deliveryOption)?.price || 0}`
                    }
                  </span>
                </div>
                <div className="flex justify-between">
