      ...
      <div className="container mx-auto px-6 pt-32 pb-16">
        ...
        <motion.div variants={itemVariants} className="text-center mb-16">
          ...
          <p className="text-xl lg:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto">
            Upload a full body photo to try on clothing using AI. Experience the
            future of online shopping with our revolutionary virtual fitting
            technology.
          </p>
        </motion.div>
        ...
        >
          <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10">
            ...
            <p className="text-gray-300">
              See how clothes look on you before buying. Our AI analyzes your
              body shape and fits clothing perfectly.
            </p>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10">
            ...
            <p className="text-gray-300">
              Advanced machine learning algorithms ensure accurate fitting and
              realistic visualization of clothing.
            </p>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10">
            ...
            <p className="text-gray-300">
              Get instant feedback on how items fit and look, making online
              shopping faster and more confident.
            </p>
          </div>
        </motion.div>
        ...
        <motion.div
          variants={itemVariants}
          className="bg-gradient-to-r from-gold/20 to-gold/10 rounded-3xl p-12 text-center border border-gold/30"
        >
          <motion.div
            animate={{
              rotate: [0, 5, -5, 0],
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
            We're working hard to bring you the most advanced virtual fitting
            experience. Be among the first to experience AI-powered fashion when
            we launch.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              size="lg"
              className="bg-gold hover:bg-gold/90 text-black font-semibold px-8 py-4 text-lg"
            >
              Get Notified
            </Button>
            <Link href="/products">
        ...
        <motion.div variants={itemVariants} className="mt-20 text-center">
          <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 max-w-2xl mx-auto">
            ...
            <p className="text-gray-300 mb-6">
              Sign up to get notified when AI LookOut launches and be among the
              first to experience the future of online fashion.
            </p>
